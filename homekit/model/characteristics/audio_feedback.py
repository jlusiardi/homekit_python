...
class AudioFeedbackCharacteristic(AbstractCharacteristic):
    ...
    def __init__(self, iid):
        AbstractCharacteristic.__init__(self, iid, CharacteristicsTypes.AUDIO_FEEDBACK,
...
class AdministratorOnlyAccessCharacteristicMixin(object):
    def __init__(self, iid):
        self._audioFeedbackCharacteristic = AudioFeedbackCharacteristic(iid)
        self.characteristics.append(self._audioFeedbackCharacteristic)

    def set_hue_set_callback(self, callback):
        self._audioFeedbackCharacteristic.set_set_value_callback(callback)

    def set_brightness_get_callback(self, callback):
        self._audioFeedbackCharacteristic.set_get_value_callback(callback)
