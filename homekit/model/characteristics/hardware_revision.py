...
class HardwareRevisionCharacteristic(AbstractCharacteristic):
    """
    Defined on page 149
    """

    def __init__(self, iid, revision):
        AbstractCharacteristic.__init__(self, iid, CharacteristicsTypes.HARDWARE_REVISION, CharacteristicFormats.string)
        self.value = revision
